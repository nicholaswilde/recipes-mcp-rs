...
- **Multi-Format Export:** Enables exporting scraped recipes into various human-readable formats, such as Markdown and Cooklang, for seamless integration into personal knowledge bases.
...
- **Granular Parsing:** Accurately identifies and separates recipe components including:
  ...
  - Metadata (image URL, image gallery, prep time, cook time, servings, cuisine, tags, nutritional information, dietary labels)
